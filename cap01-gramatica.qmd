...
## Questão 1: Componentes Essenciais

Qual é o componente mínimo necessário para criar um gráfico?
...
**Resposta: b) Data, Aesthetics e Geom**
...
::: {.callout-note collapse="true"}
## Questão 2: Mudando Coordenadas

Se você pega um gráfico de barras em coordenadas cartesianas normais e aplica `coord_flip()`, o que acontece?
...
**Resposta: b) Os eixos trocam de lugar**
...
::: {.callout-note collapse="true"}
## Questão 3: Aesthetics vs. Geom

Qual é a diferença entre `aes(color = sexo)` (aesthetics) e `geom_point()` (geometria)?
...
**Resposta: b) Aesthetics diz PARA ONDE mapear a variável; Geom diz COMO visualizá-la**
...
::: {.callout-note collapse="true"}
## Questão 4: Facets e Dados

Quando você usa `facet_wrap(~sexo)`, os dados realmente são divididos em dois datasets separados?
...
**Resposta: b) Não, é apenas uma visualização separada dos mesmos dados**
...
::: {.callout-note collapse="true"}
## Questão 5: Insight sobre Pizza Charts

Um gráfico de pizza é:
...
**Resposta: b) Uma variação do gráfico de barras em coordenadas polares**
