...
subtitle: "Fluxograma de decisão"
...
Este fluxograma conecta-se diretamente à **[Gramática dos Gráficos](cap01-gramatica.qmd)**. Lembre-se de que toda visualização mapeia variáveis a **estéticas** (position, cor, tamanho, forma) e depois escolhe um **geom** (ponto, linha, barra, etc.). O fluxograma a seguir essencialmente codifica essa lógica de mapeamento.
...
4. **Recomendação**: Gráfico de Barras
...
- [Gramática dos Gráficos](cap01-gramatica.qmd)
- [Gráfico de Pizza](cap04-pizza.qmd) (e por que evitá-los)
- [Gráfico de Barras](cap05-barras.qmd)
- [Histograma](cap06-histograma.qmd)
- [Gráfico de Densidade](cap07-densidade.qmd)
- [Boxplot](cap08-boxplot.qmd)
- [Scatter Plot](cap09-scatterplot.qmd)
- [Gráfico de Linha](cap10-linhas.qmd)
- [Curvas de Kaplan–Meier](cap10b-kaplanmeier.qmd)
