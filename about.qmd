...
<script>
const citations = {
  abnt: 'SILVA, Henrique Alvarenga da. <b>Dos Dados aos Gráficos</b>: Visualização Estatística para Profissionais de Saúde. Publicação independente, 2026. ISBN 978-65-01-98049-2. Disponível em: https://henriquealvarenga.github.io/graficos/',
  vancouver: 'Silva HA. Dos dados aos gráficos: visualização estatística para profissionais de saúde [Internet]. Publicação independente; 2026 [cited ' + new Date().getFullYear() + ']. Available from: https://henriquealvarenga.github.io/graficos/',
  apa: 'Silva, H. A. (2026). <i>Dos dados aos gráficos: Visualização estatística para profissionais de saúde</i>. Publicação independente. ISBN 978-65-01-98049-2. https://henriquealvarenga.github.io/graficos/',
...
const citationsPlain = {
  abnt: 'SILVA, Henrique Alvarenga da. Dos Dados aos Gráficos: Visualização Estatística para Profissionais de Saúde. Publicação independente, 2026. ISBN 978-65-01-98049-2. Disponível em: https://henriquealvarenga.github.io/graficos/',
  vancouver: 'Silva HA. Dos dados aos gráficos: visualização estatística para profissionais de saúde [Internet]. Publicação independente; 2026 [cited ' + new Date().getFullYear() + ']. Available from: https://henriquealvarenga.github.io/graficos/',
  apa: 'Silva, H. A. (2026). Dos dados aos gráficos: Visualização estatística para profissionais de saúde. Publicação independente. ISBN 978-65-01-98049-2. https://henriquealvarenga.github.io/graficos/',
